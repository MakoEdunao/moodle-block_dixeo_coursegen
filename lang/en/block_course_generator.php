...
$string['course_generated'] = 'Course generated successfully! You can <a href="https://123-test.edunao.com/course/view.php?id={$a}">view the course</a> or <a class="reset-prompt" href="#">generate a new one</a>.';
