...
// Editor strings
$string['editor_loading'] = 'Loading course structure...';
$string['editor_invalid_data'] = 'Invalid structure data';
$string['editor_save'] = 'Save';
$string['editor_cancel'] = 'Cancel';
$string['editor_reload'] = 'Reload';
$string['editor_save_now'] = 'Save Now';
$string['editor_autosave_in'] = 'Auto-save in:';
$string['editor_version'] = 'Version:';
$string['editor_version_loading'] = 'Loading...';
$string['editor_disabled'] = 'Disabled';
$string['editor_edit'] = 'Edit';
$string['editor_duplicate'] = 'Duplicate';
$string['editor_delete'] = 'Delete';
$string['editor_confirm_delete'] = 'Confirm Delete';
$string['editor_delete_module_confirm'] = 'Are you sure you want to delete this module?';
$string['editor_delete_section_confirm'] = 'Are you sure you want to delete this section and all its modules?';
$string['editor_reload_confirm'] = 'Reload structure from server? Unsaved changes will be lost.';
$string['editor_unsaved_changes'] = 'You have unsaved changes. Are you sure you want to leave?';
$string['editor_saving'] = 'Saving...';
$string['editor_saved'] = 'Saved!';
$string['editor_divergent_save'] = 'Divergent Save';
$string['editor_divergent_message'] = 'You were working from an older version. Your changes have been saved as version {$a} to preserve the existing version history. This is a new branch from your starting point.';
$string['editor_ok'] = 'OK';
$string['editor_add_section'] = 'Add new section';
$string['editor_add_activity'] = 'Add new activity';
$string['editor_undo'] = 'Undo';
$string['editor_redo'] = 'Redo';
$string['editor_new_section_title'] = 'New section';
$string['editor_new_section_summary'] = 'Describe what this section is about';
$string['editor_new_module_type'] = 'Page';
$string['editor_new_module_title'] = 'New page';
$string['editor_new_module_hints'] = 'Describe what this page is about';
$string['editor_copy_suffix'] = ' (Copy)';
$string['editor_change_activity_type'] = 'Change activity type';
