...
$string['editor_autosave_in'] = 'Automatisches Speichen in:';
...
$string['editor_unsaved_changes'] = 'Sie haben ungespeicherte Änderungen. Möchten Sie die Seite wirklich verlassen?';
$string['editor_saving'] = 'Speichern...';
$string['editor_saved'] = 'Gespeichert!';
$string['editor_divergent_save'] = 'Abweichend Speichern';
$string['editor_divergent_message'] = 'Sie haben mit einer älteren Version gearbeitet. Ihre Änderungen wurden als Version {$a} gespeichert, um die bestehende Versionshistorie zu erhalten. Dies ist ein neuer Zweig ab Ihrem Ausgangspunkt.';
$string['editor_ok'] = 'OK';
$string['editor_add_section'] = 'Neuen Abschnitt hinzufügen';
$string['editor_add_activity'] = 'Neue Aktivität hinzufügen';
$string['editor_undo'] = 'Rückgänig machen';
